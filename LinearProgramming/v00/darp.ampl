...
var aux_bus_in_vertex {BUS,0..T,VERTEX} binary;
...
subject to S8_2 {b in BUS, t in 1..T-1, i in VERTEX}:
	aux_bus_in_vertex[b,t,i] >= h[b,t-1,i] + h[b,t,i] - 1;
subject to S8_3 {b in BUS, t in 1..T-1}:
	(sum {(i,j) in EDGE} aux_bus_in_edge[b,t,i,j])
		+ (sum {i in VERTEX} aux_bus_in_vertex[b,t,i]) = 1;
...
subject to S11_3 {i in REQ}:
	(sum {b in BUS, t in 1..T} aux_boarding[b,t,i]) = 1;
subject to S11_4 {i in REQ}:
